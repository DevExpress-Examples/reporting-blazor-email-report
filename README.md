<!-- default badges list -->
![](https://img.shields.io/endpoint?url=https://codecentral.devexpress.com/api/v1/VersionRange/798741636/24.2.3%2B)
...
The [`DxToastProvider`](https://docs.devexpress.com/Blazor/DevExpress.Blazor.DxToastProvider) component displays validation notifications to users.
